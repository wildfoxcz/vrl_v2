...
<div style="padding-top:50px;" class="container">
    <div class="row justify-content-center">
        <img width="400" src="{{ asset('img/logo.png') }}" alt="">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('PŘEDREGISTRACE') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-right">{{ __('Znovu heslo') }}</label>
